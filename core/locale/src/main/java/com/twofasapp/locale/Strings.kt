...
class Strings(c: Context) {
    ...
    val groupsAddRefreshed = c.getString(R.string.groups__add)
    val groupsDefault = c.getString(R.string.groups__default)
    val groupsAll = c.getString(R.string.groups__all)
    val groupsTitle = c.getString(R.string.groups__title)
    val groupsAssignEntries = c.getString(R.string.groups__assign_entries)
    val groupsChangeName = c.getString(R.string.groups__change_name)
    val serviceActionsTitle = c.getString(R.string.service_actions__title)
    val serviceActionsEditDetails = c.getString(R.string.service_actions__edit_details)
    val serviceActionsChangeIcon = c.getString(R.string.service_actions__change_icon)
    val serviceActionsAssignGroup = c.getString(R.string.service_actions__assign_group)
    val serviceActionsShowQr = c.getString(R.string.service_actions__show_qr)
    val serviceActionsDeleteMessage = c.getString(R.string.service_actions__delete_message)
    val homeMenu = c.getString(R.string.home__menu)
    val homeMainMenu = c.getString(R.string.home__main_menu)
    val homeMore = c.getString(R.string.home__more)
    val commonBack = c.getString(R.string.commons__back)
    ...
    val aboutSupportAndShare = c.getString(R.string.settings__support_and_share)
    val aboutRepositories = c.getString(R.string.about_repositories)
    val aboutProjectRepository = c.getString(R.string.about_project_repository)
    val aboutOfficialRepository = c.getString(R.string.about_official_repository)
    ...
    val browserPullRequest = c.getString(R.string.browser_pull_request)
    val browserPullRequestEmpty = c.getString(R.string.browser_pull_request_empty)
    val browserPullRequestFailed = c.getString(R.string.browser_pull_request_failed)
    ...
    val settingsHomeUiMode = c.getString(R.string.settings__home_ui_mode)
    ...
    val settingsCustomColors = c.getString(R.string.appearance_custom_colors)
    val settingsCustomColorsBody = c.getString(R.string.appearance_custom_colors_description)
    val settingsCustomColor = c.getString(R.string.appearance_custom_color)
    val settingsCustomColorBody = c.getString(R.string.appearance_custom_color_description)
    ...
    val backupSettingsSetPasswordMsg = c.getString(R.string.backup_password_set_subtitle)
    val backupSettingsRemovePasswordTitle = c.getString(R.string.backup_settings_password_remove_title)
    val backupSettingsRemovePasswordMsg = c.getString(R.string.backup_password_remove_subtitle)
    ...
    val cloudBackupEntrySubtitle = c.getString(R.string.cloud_backup_entry_subtitle)
    val cloudBackupTitle = c.getString(R.string.cloud_backup_title)
    val cloudBackupProviders = c.getString(R.string.cloud_backup_providers)
    val cloudBackupStatusNotConfigured = c.getString(R.string.cloud_backup_status_not_configured)
    val cloudBackupStatusEnabled = c.getString(R.string.cloud_backup_status_enabled)
    val cloudBackupStatusDisabled = c.getString(R.string.cloud_backup_status_disabled)
    val cloudBackupViewFiles = c.getString(R.string.cloud_backup_view_files)
    ...
    val cloudBackupComplete = c.getString(R.string.cloud_backup_complete)
    val cloudBackupPartial = c.getString(R.string.cloud_backup_partial)
    val cloudBackupFailed = c.getString(R.string.cloud_backup_failed)
    val cloudBackupFilesTitle = c.getString(R.string.cloud_backup_files_title)
    val cloudBackupFilesEmpty = c.getString(R.string.cloud_backup_files_empty)
    val cloudBackupFilesLoading = c.getString(R.string.cloud_backup_files_loading)
    val cloudBackupFilesLoadFailed = c.getString(R.string.cloud_backup_files_load_failed)
    val cloudBackupRestoreTitle = c.getString(R.string.cloud_backup_restore_title)
    val cloudBackupRestoreMessage = c.getString(R.string.cloud_backup_restore_message)
    val cloudBackupRestoreSuccess = c.getString(R.string.cloud_backup_restore_success)
    val cloudBackupRestoreFailed = c.getString(R.string.cloud_backup_restore_failed)
    val cloudBackupRestorePassword = c.getString(R.string.cloud_backup_restore_password)
    val cloudBackupRestorePasswordWrong = c.getString(R.string.cloud_backup_restore_password_wrong)
    val cloudBackupDelete = c.getString(R.string.cloud_backup_delete)
    val cloudBackupDeleteTitle = c.getString(R.string.cloud_backup_delete_title)
    val cloudBackupDeleteMessage = c.getString(R.string.cloud_backup_delete_message)
    val cloudBackupDeleteSuccess = c.getString(R.string.cloud_backup_delete_success)
    val cloudBackupDeleteFailed = c.getString(R.string.cloud_backup_delete_failed)

    val webDavTitle = c.getString(R.string.webdav_title)
    val webDavBaseUrl = c.getString(R.string.webdav_base_url)
    val webDavUsername = c.getString(R.string.webdav_username)
    val webDavPassword = c.getString(R.string.webdav_password)
    val webDavDirectory = c.getString(R.string.webdav_directory)
    val webDavEnabled = c.getString(R.string.webdav_enabled)
    val webDavEnabledDescription = c.getString(R.string.webdav_enabled_description)
    val webDavTest = c.getString(R.string.webdav_test)
    val webDavTestSuccess = c.getString(R.string.webdav_test_success)
    val webDavSaved = c.getString(R.string.webdav_saved)
    val webDavRequiredFields = c.getString(R.string.webdav_required_fields)
    val webDavInvalidUrl = c.getString(R.string.webdav_invalid_url)
    val webDavUnauthorized = c.getString(R.string.webdav_unauthorized)
    val webDavNetworkError = c.getString(R.string.webdav_network_error)
    val webDavUnknownError = c.getString(R.string.webdav_unknown_error)
